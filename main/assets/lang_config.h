...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char p3_4G_MODE_start[] asm("_binary_4G_MODE_p3_start");
        extern const char p3_4G_MODE_end[] asm("_binary_4G_MODE_p3_end");
        static const std::string_view P3_4G_MODE {
        static_cast<const char*>(p3_4G_MODE_start),
        static_cast<size_t>(p3_4G_MODE_end - p3_4G_MODE_start)
        };
        ...
        extern const char p3_Neting_start[] asm("_binary_Neting_p3_start");
        extern const char p3_Neting_end[] asm("_binary_Neting_p3_end");
        static const std::string_view P3_NETING {
        static_cast<const char*>(p3_Neting_start),
        static_cast<size_t>(p3_Neting_end - p3_Neting_start)
        };

        extern const char p3_WIFI_MODE_start[] asm("_binary_WIFI_MODE_p3_start");
        extern const char p3_WIFI_MODE_end[] asm("_binary_WIFI_MODE_p3_end");
        static const std::string_view P3_WIFI_MODE {
        static_cast<const char*>(p3_WIFI_MODE_start),
        static_cast<size_t>(p3_WIFI_MODE_end - p3_WIFI_MODE_start)
        };
        ...
        extern const char p3_aec_no_start[] asm("_binary_aec_no_p3_start");
        extern const char p3_aec_no_end[] asm("_binary_aec_no_p3_end");
        static const std::string_view P3_AEC_NO {
        static_cast<const char*>(p3_aec_no_start),
        static_cast<size_t>(p3_aec_no_end - p3_aec_no_start)
        };

        extern const char p3_aec_off_start[] asm("_binary_aec_off_p3_start");
        extern const char p3_aec_off_end[] asm("_binary_aec_off_p3_end");
        static const std::string_view P3_AEC_OFF {
        static_cast<const char*>(p3_aec_off_start),
        static_cast<size_t>(p3_aec_off_end - p3_aec_off_start)
        };

        extern const char p3_bat_low_start[] asm("_binary_bat_low_p3_start");
        extern const char p3_bat_low_end[] asm("_binary_bat_low_p3_end");
        static const std::string_view P3_BAT_LOW {
        static_cast<const char*>(p3_bat_low_start),
        static_cast<size_t>(p3_bat_low_end - p3_bat_low_start)
        };
